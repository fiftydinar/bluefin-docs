...
<ReleaseContributors
  contributors={[
    ...
    { login: "akeeton" },
    { login: "alatiera", roles: ["maintainer", "gnome-os"] },
    ...
    { login: "apwiggins" },
    { login: "arvindautar" },
    { login: "AtiusAmy", role: "artist" },
    { login: "AtomHare" },
    { login: "awkorama" },
    { login: "bdflemin" },
    { login: "befanyt", role: "maintainer" },
    { login: "bketelsen", roles: ["ublue-maintainer", "aurora-maintainer", "bluefin-emeritus", "ucore-contributor"], nickname: "Architect of the Final Shape" },
    { login: "Bira-oliverio" },
    { login: "Blackstep590" },
    { login: "bronson", role: "ucore-contributor" },
    { login: "bsherman", roles: ["ucore-maintainer", "bluefin-emeritus"] },
    { login: "buggerman" },
    { login: "carpediem29" },
    { login: "castrojo", roles: ["maintainer", "ublue-emeritus", "bazzite-contributor"], nickname: "[ Redacted ]" },
    { login: "CEN90" },
    { login: "chandeleer1698", role: "artist" },
    { login: "cmars" },
    { login: "coxde", role: "ucore-contributor" },
    { login: "d3spairx" },
    ...
    { login: "dragon28" },
    { login: "dragonbass13" },
    { login: "dreamyukii", roles: ["aurora-maintainer", "ublue-contributor"] },
    { login: "dtg01100" },
    { login: "dx4homelab" },
    { login: "dylanmtaylor", roles: ["bazzite-contributor", "ucore-contributor"] },
    { login: "dylanvdmerwe" },
    { login: "edermats32" },
    { login: "eltorrero" },
    { login: "ExistingPerson08" },
    { login: "EyeCantCU", roles: ["bazzite-maintainer", "bluefin-emeritus"] },
    { login: "fiftydinar", roles: ["ublue-contributor", "bazzite-contributor"] },
    { login: "fizzyizzy05" },
    { login: "FlammLex" },
    { login: "fonnesbeck" },
    ...
    { login: "goozkan" },
    { login: "h1zardian" },
    { login: "hanthor", role: "maintainer", nickname: "Herald of Finality" },
    { login: "hawkticehurst" },
    { login: "hecknt" },
    { login: "HikariKnight", roles: ["ublue-maintainer", "bazzite-maintainer"] },
    { login: "inffy", roles: ["maintainer", "ublue-maintainer", "aurora-maintainer"] },
    { login: "istvan-derda" },
    { login: "JarrColl" },
    { login: "jfmongrain" },
    { login: "JimOswick" },
    ...
    { login: "KotlinGeekDev" },
    { login: "kriszentner" },
    { login: "KyleGospo", roles: ["maintainer", "ublue-maintainer", "bazzite-maintainer", "ucore-contributor"], nickname: "The First Knife" },
    { login: "leafyoung" },
    { login: "ledif", roles: ["ublue-maintainer", "aurora-maintainer"] },
    { login: "lkdm" },
    { login: "LorbusChris" },
    { login: "louhitar" },
    { login: "m2Giles", roles: ["maintainer", "ublue-maintainer", "ucore-contributor"] },
    { login: "madsiur" },
    { login: "malgam" },
    { login: "maphew" },
    { login: "mattbuys" },
    ...
    { login: "mmartinortiz" },
    { login: "NahsiN" },
    { login: "nicknamenamenick", role: "bazzite-contributor" },
    { login: "NiHaiden", role: "artist" },
    { login: "nikodunk", role: "ucore-contributor" },
    ...
    { login: "Readpato" },
    { login: "renner0e", roles: ["maintainer", "aurora-maintainer", "ublue-maintainer", "bazzite-contributor"] },
    { login: "repires" },
    ...
    { login: "travier", roles: ["ublue-contributor", "ucore-contributor"] },
    { login: "tulilirockz", roles: ["maintainer", "ublue-maintainer", "aurora-maintainer"] },
    { login: "tunix" },
    { login: "valentindavid", role: "gnome-os" },
    { login: "valerie-tar-gz" },
    { login: "wommy" },
    { login: "Zeglius", role: "bazzite-maintainer" },
    { login: "zeroby0" },
  ]}
/>
## Chatterbox
