...
{/* Replace src with your own recording when ready — currently using the official GNOME 50 release screenshot */}
<BlogFigure
  src="https://release.gnome.org/50/document-viewer-annotations.webp"
  alt="GNOME 50 Document Viewer with new annotation tools"
  caption="GNOME 50 'Tokyo' — Document Viewer with overhauled annotations. Replace with your own GIF or MP4."
  maxWidth="720px"
/>
