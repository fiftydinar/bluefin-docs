...
- [GNOME 50](https://release.gnome.org/50/), Linux 6.19.x, Mesa 26.x, and [Freedesktop SDK] 25.08.11 libraries
...
- Efficient layering - this image uses the upstream [chunkah](https://github.com/coreos/chunkah) tool for more efficient downloads. We expect efficient delta downloads to land sometime this summer, but the infrastructure is in place now
...
<DownloadCard
  ...
  entries={[
    {
      label: "AMD / Intel",
      isoUrl: "https://projectbluefin.dev/dakota-live-alpha2.iso",
      isoFilename: "dakota-live-alpha2.iso",
      checksumUrl: "https://projectbluefin.dev/dakota-live-alpha2.iso-CHECKSUM",
    },
    {
      label: "Nvidia",
      isoUrl: "https://projectbluefin.dev/dakota-nvidia-live-alpha2.iso",
      isoFilename: "dakota-nvidia-live-alpha2.iso",
      checksumUrl: "https://projectbluefin.dev/dakota-nvidia-live-alpha2.iso-CHECKSUM",
    },
  ]}
/>
...
[Freedesktop SDK libraries]: https://freedesktop-sdk.io/
