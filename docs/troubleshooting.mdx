...
Bluefin features a dynamic help and troubleshooting system powered by the leading edge tools such as Goose, etc. In the menu select "Ask Bluefin" to use the chat agent. 


<img src="https://github.com/user-attachments/assets/c4116f0b-47e5-43f8-97fd-c55fbe373d01" alt="askbluefin" />
