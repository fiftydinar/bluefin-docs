...
The charts below are sourced from [Linux Foundation Insights](https://insights.linuxfoundation.org/project/ublue-os-bluefin) and track the `projectbluefin/bluefin` repository. For org-wide metrics across all 15 factory repos, see the [Factory dashboard](/factory).
...
For the full picture across all factory repositories, visit the [Factory Dashboard](/factory).
