...
| ---------- | ------- | ------------------------------------------------------------------------- |
| `:stable`  | Stable  | GNOME 51 — production. Mon/Wed/Fri automated promotion from `:testing`.   |
| `:testing` | Testing | GNOME 51 — daily builds from the `testing` branch. Boot-check gated.      |
...
<DriverVersionsCatalog streamId="dakota-stable" />
